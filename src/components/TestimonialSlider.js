          ...
          <SwiperSlide className="swiper-slide">
            ...
            >
              <div className="text">
                ...
                <p>
                  Noyal delivered our web application ahead of schedule with immaculate code quality and a flawless user experience.
                </p>
              </div>
              <div className="image">
                <img src="assets/images/team3.jpg" alt="Sarah Jenkins" />
              </div>
              <div className="info">
                <h3 className="name">Sarah Jenkins</h3>
                <div className="author">Product Lead at TechScale</div>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide className="swiper-slide">
            ...
            >
              <div className="text">
                ...
                <p>
                  Exceptional full-stack expertise. Noyal handled both frontend UI and backend architecture seamlessly.
                </p>
              </div>
              <div className="image">
                <img src="assets/images/avatar.png" alt="David Miller" />
              </div>
              <div className="info">
                <h3 className="name">David Miller</h3>
                <div className="author">CTO at CloudVentures</div>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide className="swiper-slide">
            ...
            >
              <div className="text">
                ...
                <p>
                  Working with Noyal was a great experience. High attention to detail, proactive communication, and top-tier execution.
                </p>
              </div>
              <div className="image">
                <img src="assets/images/team3.jpg" alt="Alex Rivera" />
              </div>
              <div className="info">
                <h3 className="name">Alex Rivera</h3>
                <div className="author">Founder at StudioX</div>
              </div>
            </div>
          </SwiperSlide>
        </div>
