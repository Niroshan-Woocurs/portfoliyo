...
const WorksList = () => {
  return (
    <Layout>
      <Head>
        <title>All Projects | Noyal Niroshan</title>
        <meta
          name="description"
          content="Comprehensive list of software engineering and web development projects by Noyal Niroshan."
        />
      </Head>
          ...
          <div className="row">
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              ...
              <div className="h-titles">
                <h1 className="h-title">All Projects</h1>
              </div>
            </div>
          </div>
        </div>
